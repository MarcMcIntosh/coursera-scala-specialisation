  ...
  extends Quad {
    ...
    def insert(b: Body): Quad = {
      if (size <= minimumSize) Leaf(centerX, centerY, size,  b +: bodies)
        ...
        val quaterSize = size / 4
        val halfSize = size / 2
        val nw = Empty(centerX - quaterSize, centerY - quaterSize, halfSize)
        val ne = Empty(centerX + quaterSize, centerY - quaterSize, halfSize)
        val sw = Empty(centerX - quaterSize, centerY + quaterSize, halfSize)
        val se = Empty(centerX + quaterSize, centerY + quaterSize, halfSize)
